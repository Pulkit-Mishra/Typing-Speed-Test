words = ['grapes','Mango','Apple','gun','fan','door','tv','mobile','laptop', 'electricity', 'dictionary','copper','measure','pleasant','scare','tie','unlock','vision','want','young','polar','match','farm','digest','chair','brave','document','escape','global','hammer','insane','mainland','music','override','process','report','school','twinkle']
